(function () {
    ...
    function setMapa(coords) {
        ...
        actualiza_calle(CusLat, CusLon);//Actualizamos la calle
        ...
        marker.addListener('dragend', function (event) {
            ...
            actualiza_calle(this.getPosition().lat(), this.getPosition().lng());//Actualizamos la calle nuevamente
